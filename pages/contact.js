  ...
  return (
    ...
    <main className={styles.main}>
        ...
        <div className={styles.mainDiv} >
          ...
          <form className={styles.contactForm} action="https://formsubmit.co/322a7123cad28ab28c2d13e69a655775" method="POST">
            <label>Please, tell me who you are: </label>
            <input type="text" name="name" placeholder="Your name" required></input>
            <label>And why are you contacting me: </label>
            <input type="text" name="_subject" placeholder="Reason to contact" required></input>
